...
class RegisterActivity : AppCompatActivity() {
    ...
    private val binding: ActivityRegisterBinding
        get() = _binding ?: throw IllegalStateException("ActivityRegisterBinding is not initialized")
        ...
        binding.registerButton.setOnClickListener {
            ...
            if (file != null) {
                if (file.length() > 10 * 1024 * 1024) { // если фото больше 10mb
                    Toast.makeText(this, "File size exceeds the limit (10MB)", Toast.LENGTH_SHORT).show()
                } else {
